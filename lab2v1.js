...
function draw() {
	...
	translate(0,318);
	fill(101,109,119);
	quad(0,413,421,413,428,434,0,434);
	pop();
	...
	stroke(101,109,119);
	strokeWeight(0.8);
	triangle(139,24,133,0,130,0);
	triangle(154,34,143,0,140,0);
	triangle(169,20,163,0,160,0);
	triangle(352,30,343,0,340,0);
	triangle(447,69,430,0,425,0);
	triangle(512,40,499,0,496,0);
